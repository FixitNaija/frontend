        ...
        <div >
            <div className=' bg-[url(../src/assets/Hero.jpg)] bg-cover bg-no-repeat  h-[450px] sm:h-[700px] relative'>
                ...
                <div className='relative z-10'>
                    ...
                    <Link to='/Issue'>
                     <button  className='border font-poppins  text-[16px] leading-[24px] sm:text-base font-medium border-[#15803D] bg-[#15803D] text-[#fff] rounded-[8px] sm:rounded-lg w-[170px] sm:w-[183px] h-[48px] pt-[12px] pb-[12px]  pl-[24px] sm:pl-[42px]  pr-[24px] sm:pr-[42px] ml-[16px] sm:ml-[100px]  mr-[110px] sm:mr-[323px] mt-[32px] sm:mt-[84px]'>Report Issue</button>
                    </Link>
                </div>
            </div>
            <div className='block sm:flex justify-between items-center  ml-[16px] sm:ml-[0px] sm:mr-[16px]  mt-[24px] sm:mt-[40px]'>
                <div className=' w-[358px] sm:w-[286px] h-[148px] block justify-center align-center text-center  ml-[-10px] sm:ml-[10px] mt[40px]' >
